...
import PopperComponent, { popperPlacementPositions } from './components/popper_component/popper_component'
import classnames from 'classnames'
import { isSameDay, isDayDisabled, isDayInRange, getEffectiveMinDate, getEffectiveMaxDate, parseDate, safeDateFormat } from './utils/date_utils.js'
...
export default class DatePicker extends React.Component {
  ...
  renderDateInput = () => {
    ...
    const customInput = this.props.customInput || <DateInput icon='calendar' iconSize='medium' onIconClick={this.onInputClick} />
